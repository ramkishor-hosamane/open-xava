 ...
 * Generated at: 2021-01-20 05:39:35 UTC
...
for (Chart.ChartType type: Chart.ChartType.values()) {
	...
	String cssStyle = (type == chart.getChartType())?"pointer-events: none; cursor: default;":""; // Must be inline, in the CSS class produces an ugly trembling effect
      ...
      try {
        ...
        // /xava/editors/chartTypeEditor.jsp(17,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
        _jspx_th_xava_005flink_005f0.setAction("Chart.selectType");
        // /xava/editors/chartTypeEditor.jsp(17,0) name = argv type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
        _jspx_th_xava_005flink_005f0.setArgv("chartType=" + type.name());
        // /xava/editors/chartTypeEditor.jsp(17,0) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
        _jspx_th_xava_005flink_005f0.setCssClass(selected);
        // /xava/editors/chartTypeEditor.jsp(17,0) name = cssStyle type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
        _jspx_th_xava_005flink_005f0.setCssStyle(cssStyle);
